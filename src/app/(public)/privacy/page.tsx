...
export const metadata: Metadata = {
  description: 'Conheça nossas políticas de privacidade e proteção de dados pessoais. Transparência total sobre como seus dados são utilizados na plataforma Corgly.',
