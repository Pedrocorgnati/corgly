...
export default function DashboardError({
  ...
  return (
    // A largura da pagina logada mora SO no PageWrapper (max-w-6xl). Repetir o
    // literal aqui fazia a tela de erro divergir da pagina e do loading.tsx
    // quando alguem mexesse na casca.
    <PageWrapper data-testid="dashboard-error">
