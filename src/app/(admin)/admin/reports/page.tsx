...
export default async function AdminReportsPage() {
  ...
  return (
    <PageWrapper data-testid="page-admin-reports">
      <div data-testid="admin-reports-header" className="mb-6">
      ...
      <div className="mt-6 bg-card border border-border rounded-2xl p-6 shadow-sm">
        ...
        {recent.length === 0 ? (
          <p data-testid="admin-reports-empty" className="text-sm text-muted-foreground">Nenhum download registrado ainda.</p>
        ) : (
          <div data-testid="admin-reports-table" className="overflow-x-auto">
            <table className="w-full text-sm">
              ...
              <tbody>
                {recent.map((r) => {
                  ...
                  return (
                    <tr key={r.id} data-testid={`admin-reports-row-${r.id}`} className="border-b border-border/50">
